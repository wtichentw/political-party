...
(function () {
  ...
  Sea.prototype = {
  		...
  		preload:function(){
  			this.load.image('background','media/sea/background.png');
  			game.load.image("ninja", "media/sea/ninja.png");
  			game.load.image("pole", "media/sea/pole.png");
        game.load.image("powerbar", "media/sea/powerbar.png");
  		},
  		create:function(){
