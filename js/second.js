...
Second.prototype = {
	preload: function(){
		game.load.image("atari", "media/second/crate.png");
		game.load.image("ground", "media/second/ground.png");
    game.load.image('background','media/second/background.png');
    game.load.spritesheet('dude', 'media/second/dude.png', 32, 48);
	},
  	create: function(){
    bg = game.add.tileSprite(0, 0, 1720, 720, 'background');
    //var groundSprite = game.add.sprite(0, 573, "ground");
    ...
    var groundBoxesCM = game.physics.p2.createContactMaterial(worldMaterial, boxMaterial, { friction: 0.2 });
